        ...
        for (i=0;i<=respuesta.length;i++){
            try{
                ...
                if(b==true){
                    ...
                    html+='<h3><a href="#">'+so+'</a></h3><div id="g_'+id_select+'"><div>Grupos de software:&nbsp;<select id="'+id_select+'"><option value="0">--- Grupos ---</option>'+grupos+'</select></div>';
                    js+='$("#'+id_select+'").live("change", function(){var r= ajax_peticion_json(\'index.php/equipo_software/getSwGru/\'+$(this).val()); $("#g_'+id_select+' input[type=checkbox]").each(function() { '+
                    'this.checked = false; }); marcaSW(r); });  '; 
                 }
