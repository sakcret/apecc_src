                ...
                <div class="ui-widget">
                    <div class="ui-state-highlight ui-corner-all" style="padding: 0 .7em;">
                        <p><span class="ui-icon ui-icon-alert" style="float: left; margin-right: .3em;"></span>
                            <strong>Atenci&oacute;n:</strong> Antes de agregar el usuario del sistema, verifique que se le han asignado permisos correspondientes, 
                        ...
                        <table id="tb_permisos" class="ui-grid-content ui-widget-content" style=" width: 100%" >
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td rowspan="8" class="ui-state-focus">&nbsp;</td>
                                ...
                                <tr>
                                    <td class="ui-state-focus">Tipos de usuario(CC)</td>
                                    <td class="ui-state-focus"><input type="checkbox" value="ust_a" class="ust checkbox-ui" name="prm[]" id="a_ust" disabled="disabled"></td>
                                    <td class="ui-state-focus">&nbsp;</td>
                                    <td class="ui-state-focus"><input type="checkbox" value="ust_c" class="ust checkbox-ui" name="prm[]" id="c_ust" disabled="disabled"></td>
                                    <td class="ui-state-focus">&nbsp;</td>
                                    <td class="ui-state-focus"><input type="checkbox" value="ust_v" class="checkbox-ui" name="prm[]" id="v_ust" disabled="disabled"></td>
                                    <td class="ui-state-focus"><input type="checkbox" value="ust_t" class="checkbox-ui"name="prm[]" id="t_ust" disabled="disabled"></td>
                                </tr>
                                <tr>
        ...
        <div id="tabsm">
            <div class="r_usu ui-widget-content ui-corner-all boxshadowround">
                ...
                <div class="ui-widget">
                    <div class="ui-state-highlight ui-corner-all" style="padding: 0 .7em;">
                        <p><span class="ui-icon ui-icon-alert" style="float: left; margin-right: .3em;"></span>
                            <strong>Atenci&oacute;n:</strong> Antes de agregar el usuario del sistema, verifique que se le han asignado permisos correspondientes.</p>
                    </div>
                </div>
            </div>
                    ...
                    <div  id="m_datos_act_asign" class="ui-grid ui-widget ui-widget-content ui-corner-all" style=" width: 98%" >
                        ...
                        <table id="m_tb_permisos" class="ui-grid-content ui-widget-content" style=" width: 100%" >
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td class="ui-state-focus">Tipos de usuario(CC)</td>
                                    <td class="ui-state-focus"><input type="checkbox" value="ust_a" class="ust checkbox-ui" name="prm[]" id="m_a_ust" disabled="disabled"></td>
                                    <td class="ui-state-focus">&nbsp;</td>
                                    <td class="ui-state-focus"><input type="checkbox" value="ust_c" class="ust checkbox-ui" name="prm[]" id="m_c_ust" disabled="disabled"></td>
                                    <td class="ui-state-focus">&nbsp;</td>
                                    <td class="ui-state-focus"><input type="checkbox" value="ust_v" class="checkbox-ui" name="prm[]" id="m_v_ust" disabled="disabled"></td>
                                    <td class="ui-state-focus"><input type="checkbox" value="ust_t" class="checkbox-ui"name="prm[]" id="m_t_ust" disabled="disabled"></td>
                                </tr>
                                <tr>
                                    <td class="ui-state-focus">Pr&eacute;stamo de controles<font style=" font-size: 8px;">(Equipos de proyecci&oacute;n)</font></td>
...
<script type="text/javascript" charset="utf-8">
    ...
    $(document).ready(function(){
        ...
        $("#t_ust").live('change',function(){marca_prm($(this),'f_permisos','ust');});
        $("#t_prc").live('change',function(){marca_prm($(this),'f_permisos','prc');});
        ...
        $("#v_ust").live('change',function(){desmarca_prm($(this),'f_permisos','ust'); });
        $("#v_prc").live('change',function(){desmarca_prm($(this),'f_permisos','prc'); });
        ...
        $("#m_t_ust").live('change',function(){marca_prm($(this),'m_f_permisos','ust');});
        $("#m_t_prc").live('change',function(){marca_prm($(this),'m_f_permisos','prc');});
        ...
        $("#m_v_ust").live('change',function(){desmarca_prm($(this),'m_f_permisos','ust'); });
        $("#m_v_prc").live('change',function(){desmarca_prm($(this),'m_f_permisos','prc'); });
