...
<div style="margin-top: 10px; margin-left: 30px; margin-right: 30px;" class="row1"> 
                                ...
                                chart = new Highcharts.Chart({
                                    ...
                                    subtitle: {
                                        text: document.ontouchstart === undefined ?
                                            'Para hacer zoom en el gráfico, da click sobre este y sin soltar arrastra hasta el completar el subperiodo deseado' :
                                            'Para hacer zoom en el gráfico, da click sobre este y sin soltar arrastra hasta el completar el subperiodo deseado'
