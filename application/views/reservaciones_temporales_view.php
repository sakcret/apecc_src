<div class="row hide">
    <div id="dialog_asignacion_momentanea" onLoad="window.setTimeout('mostrar_hora()',1000);" title="Reservaciones Moment&aacute;neas" >
    ...
    <div id="dialog_termina_actualiza_reserv" title="Reservaciones Moment&aacute;neas (Terminar Reservaci&oacute;n)" style="display:none;">
                        ...
                        "Aceptar": function() {
                            ...
                            if(bValid&&sihayquiero){
                                ...
                                if(puedereserv=='puede'){
                                    ...
                                    if (respuesta!=false){
                                        notificacion_tip("./images/msg/ok.png","Reservaciones moment&aacute;neas","La reservaci&oacute;n se registr&oacute; satisfactoriamente.");
                    ...
                    $( "#dialog_termina_actualiza_reserv").dialog({
                        ...
                        buttons: {
                            "Terminar Reservación": function() {
                                ...
                                if (respuesta=='ok'){
                                    notificacion_tip("./images/msg/ok.png","Reservaciones moment&aacute;neas (Terminar reservación)","Se ha terminado la reservaci&oacute;n.");
