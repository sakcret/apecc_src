...
<div class="row">
    <div class="twelvecol last">
        <div id="accordion_tiporep">
            ...
            <div class="ui-state-focus">
                <div class=" ui-widget-content" id="f_reporte_rss" style=" padding: 20px !important;">
                    <p class="tips_reporte_uso ui-corner-all">El nombre del reporte aparecer&aacute; en el reporte, por lo tanto se sugiere elegir un nombre de acuerdo a los parametros elegidos.
                        <br>
                        Ejemplo: Si se elige filtro por nombre Actividad='Algoritmos' colocar un nombre como 'Reservaciones para la clase de Algoritmos'.</p>
                    <form method="POST" action="<?php echo base_url(); ?>index.php/reportes_per/reporte_software_equipo" target="_blank" id="form_reporte_swe">
                        <fieldset>
                            <table width="100%" border="0">
                                <tr>
                                    <td colspan="3">
                    ...
                    <div class=" button_bar" >
                        <div align="center" class="button_bar_content">
                            <button style="" id="btn_savepdf_swe" class="prm_r"><img src="./images/save_pdf.ico"/>&nbsp;Generar Reporte PDF</button>
                            <button style="" id="btn_savexls_swe" class="prm_r"><img src="./images/save_xls.png"/>&nbsp;Generar Reporte XLS</button>
                        </div>
                    </div>
                </div>
                <div class="ui-widget">
            ...
            <h3><a href="#">Reporte de Pr&eacute;stamo de Controles de Equipos de Proyeccci&oacute;n</a></h3>
            <div class="ui-state-focus">
                <div class=" ui-widget-content" id="f_reporte_uso" style=" padding: 20px !important;">
                    <p class="tips_reporte_uso ui-corner-all">El nombre del reporte aparecer&aacute; en el reporte, por lo tanto se sugiere elegir un nombre de acuerdo a los parametros elegidos.
                    <form method="POST" action="<?php echo base_url(); ?>index.php/reportes_per/reporte_prestamo_controles" target="_blank" id="form_reporte_rpc">
                        <fieldset>
                            <table width="100%" border="0">
                                <tr>
                                    <td colspan="3">
                                        <label for="nom_rep_pres">Titulo del reporte:</label><br>
                                        <input type="text" name="nom_rep_pres"  value="Reporte de Pr&eacute;stamo de Controles de Equipos de Proyeccci&oacute;n" class="text" id="nom_rep_pres">
                                    </td>
                                </tr>
                                <tr>
                                    <td width="35%">
                                ...
                                <tr>
                                    <td>
                                        <label for="edo_rpc">Estado de pr&eacute;stamo:</label><br>
                                        <select class="selectmenu-ui" width="90%" name="edo_rpc" id="edo_rpc">
                                            <option selected value="t">Todos</option>
                                    ...
                                    <td>
                                        <label for="act_rpc">Nombre de la Actividad:</label><br>
                                        <input type="text" name="act_rpc" id="act_rpc" class="text">
                                    </td>
                                    <td>
                                        <label for="salon_rpc">Sal&oacute;n:</label><br>
                                        <input type="text" name="salon_rpc" id="salon_rpc" class="text">
                                    </td>
                                </tr>
                            </table>
                        </fieldset>
