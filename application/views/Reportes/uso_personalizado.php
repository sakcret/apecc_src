...
<center align="center" class="titulo"><h3><?php echo $titulo_rep; ?>  en el historial de usuarios eliminados</h3></center>
<?php $horas_total = 0;
$money_total = 0; ?>
<div  id="datos_act_asignu" >
    <table id="tb_repsemo" class="table" border="1" style=" width: 100%">
        <thead>
            <tr>
                <th>Fecha</th>
                <th>Hora Inicio</th>
        ...
        <?php
        foreach ($datos_reservaciones_historial->result() as $r) {
            $importe = $r->importe;
            $money_total+=$importe;
            $horas = $r->horas;
            $horas_total+=$horas;
            ...
            <tr>
                <td><?php echo $this->utl_apecc->getdate_SQL($r->fecha) ?></td>
                <td><?php echo $r->horainicio ?></td>
                <td><?php echo $r->horafin ?></td>
                <td align="right"><?php echo $horas ?></td>
                <td align="right"><?php echo '$ ' . number_format($importe, 2, ".", ","); ?></td>
                <td><?php echo $r->sala ?></td>
                <td><?php echo $r->login ?></td>
...
<?php
if ($datos_reservaciones_historial->num_rows() == 0) {
    echo '<h3 class=" round_div"><img src="./images/warning.png" alt=" ">&nbsp;No se encontraron resultados</h3>';
} else {
    echo '<br> <img style=" width: 100%" src="./images/barra.png"><center align="center" style="text-align: center !important;"> <b>Resultado: ' . $datos_reservaciones_historial->num_rows() . ' Reservaciones.</b></center> <img style=" width: 100%" src="./images/barra.png"><br>';
}
?>
<style>
    h3{
