...
if ($datos_controles->num_rows() == 0) {
    ...
    echo '<br> <img style=" width: 100%" src="./images/barra.png"><center align="center" style="text-align: center !important;"> <b>Resultado: ' . $datos_controles->num_rows() . ' Pr&eacute;stamos.</b></center> <img style=" width: 100%" src="./images/barra.png"><br>';
}
