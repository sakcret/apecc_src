...
$this->table->set_heading('N&uacute;mero de Serie','Software');
...
if ($datos_sw->num_rows() == 0) {
    ...
    echo '<br> <img style=" width: 100%" src="./images/barra.png"><center align="center" style="text-align: center !important;"> <b>Resultado: ' . $datos_sw->num_rows() . ' Equipos.</b></center> <img style=" width: 100%" src="./images/barra.png"><br>';
}
?>
