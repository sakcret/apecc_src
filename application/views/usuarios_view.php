...
<div id="f_agregar_usuario" title="Agregar un Usuario" style="display:none;">
    ...
    <form method="POST" action="" id="form_agrega_usuario">
        <table border="0">
            <tr>
                <td colspan="3"><label for="login" >Login(Solo lectura):</label>
                    <input type="text" name="login" id="login"  readonly="readonly" maxlength="10"  class="text" /></td>
            </tr>
            <tr>
                <td colspan="3"><label for="nombre">Nombre(s)*:</label>
                    <input type="text" name="nombre" id="nombre" onblur="trimOnBlur($(this));" maxlength="20" class="text" /></td>
            </tr>
            <tr>
                <td width="48%"> <label for="apaterno">Apellido Paterno*:</label>
                    <input type="text" name="apaterno" id="apaterno" onblur="trimOnBlur($(this));" maxlength="15" class="text" /></td>
                <td width="4%">&nbsp;</td>
                <td width="48%"><label for="amaterno">Apellido Materno*:</label>
                    <input type="text" name="amaterno" id="amaterno" onblur="trimOnBlur($(this));" maxlength="15" class="text" /></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td>&nbsp;</td>
                <td><label for="ncredencial">N&uacute;mero de credencial(Solo lectura):</label>            
                    <input type="text" name="ncredencial" id="ncredencial" maxlength="9" readonly class="text" /></td>
            </tr>
            <tr>
                <td><label for="pass">Password:</label>            
                    <input type="text" onfocus="calcula_pass($(this))" name="pass" id="pass" maxlength="8" class="text" /></td>
                <td>&nbsp;</td>
                <td><font Style=" font-size: 10px !important;">Se calcular&aacute; un password al dar clic sobre el textbox con etiqueta 'password'
                    <br>En caso de desearlo especificar otro.
                    </font></td>
            </tr>
        </table> 
    </form>
...
<div id="f_modificar_usuario" title="Modificar Usuario" style="display:none;">
    ...
    <form method="POST" action="" id="form_modifica_usuario">
        <table width="100%" border="0">
            <tr>
                <td colspan="3"><label for="m_login" >Login(Solo lectura):</label>
                    <input type="text" name="m_login" id="m_login" readonly maxlength="10"  class="text" /></td>
            </tr>
            <tr>
                <td colspan="3"><label for="m_nombre">Nombre(s)*:</label>
                    <input type="text" name="m_nombre" id="m_nombre" maxlength="20" class="text" /></td>
            </tr>
            <tr>
                <td width="48%"><label for="m_apaterno">Apellido Paterno*:</label>
                    <input type="text" name="m_apaterno" id="m_apaterno" maxlength="15" class="text" /></td>
                <td width="4%">&nbsp;</td>
                <td width="48%"><label for="m_amaterno">Apellido Materno*:</label>
        ...
        <div class="twelvecol last">
            <div class=" button_bar" >
                <div class="button_bar_content">
                    ...
                    <button style="height: 28px !important; width: 250px;" id="mas_opc_busq"class="opc">Ver b&uacute;squeda avanzada</button>
...
<script type="text/javascript" charset="utf-8">
    ...
    function calcula_pass(obj){
        var cad=$('#login').val();
        if(obj.val!=''){
            var respuesta = ajax_peticion('index.php/usuarios/getPassword/'+cad,'');
            obj.val(respuesta);
        }
    }
        ...
        $( "#f_agregar_usuario" ).dialog({
            ...
            buttons: {
                "Agregar Usuario": function() {                    
                    ...
                    bValid = bValid && campoVacio(pass,"Password",tips);
                    if(matesobliga) {
                        esMaestro='no';
                        bValid = bValid && campoVacio(matricula,"Matricula",tips);
                        bValid = bValid && validaCampoExpReg(matricula,/^\S\d{8}$/,"Matricula inválida... El formato de la 'Matricula debe ser: una letra S seguida de 8 números \nEjemplo: S07010150.",tips );
