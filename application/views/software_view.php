...
<script type="text/javascript" charset="utf-8">
    ...
    function desasignar_grupo(idgru,idsw){
        $('#mensaje').html('<div id="desasigna_grupo" title="Desasignar grupo de sofware" class="hide">'+
            '<p><span  style="float:left; margin:0 7px 20px 0;"><img src="./images/msg/warning.png"/></span>'+
            '&nbsp;&nbsp;Se desasignar&aacute; el grupo del  software seleccionado. '+
            '¿Deseas Continuar?</p></div>');
                ...
                "Asignar Grupo": function() {
                    ...
                    if ( bValid ) {
                        ...
                        if (respuesta=='ok'){
                            ...
                            notificacion_tip("./images/msg/ok.png","Asignar Grupo de Software","Se asign&oacute; el grupo satisfactoriamente.");
                        }else{
                            mensaje($( "#mensaje" ),'Error ! ','./images/msg/error.png',respuesta,'<span class="ui-icon ui-icon-lightbulb"></span>Actualiza la pagina e intenta de nuevo. Si el <b>Error</b> persiste consulta al administrador.');
                        }
                        $( this ).dialog( "close" );
    ...
    function elimina_software(id){
        $('#mensaje').html('<div id="dialog_elimina_sw" title="Eliminar sofware" class="hide">'+
            '<p><span  style="float:left; margin:0 7px 20px 0;"><img src="./images/msg/warning.png"/></span>'+
            '<b>Importante: &nbsp;&nbsp;</b><br> -Se eliminar&aacute; la asociaci&oacute;n con cualquier grupo. <br>- Se eliminar&aacute; la asociaci&oacute;n de este software con cualquier equipo.'+
            '<br><b>&nbsp;&nbsp; ¿Deseas Continuar?</b></p></div>');
    ...
    function elimina_so(id){
        $('#mensaje').html('<div id="dialog_elimina_so" title="Eliminar Sistema Operativo" class="hide">'+
            '<p><span  style="float:left; margin:0 7px 20px 0;"><img src="./images/msg/warning.png"/></span>'+
            '<b>Importante: &nbsp;&nbsp;</b><br> -Se eliminar&aacute; la asociaci&oacute;n del sistema con grupos software y las asignaciones de software que tengan este sistema. <br>'+
            '<br>&nbsp;&nbsp;<b>¿Deseas Continuar?</b></p></div>');
